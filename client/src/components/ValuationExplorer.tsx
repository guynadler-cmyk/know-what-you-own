...
import { VALUATION_QUADRANT_DATA, getStrengthStyles, type ValuationSignalStrength, type SignalColor, type ValuationQuadrantData } from "@/lib/valuationData";
export { VALUATION_QUADRANT_DATA, getStrengthStyles, type ValuationSignalStrength, type SignalColor, type ValuationQuadrantData };
